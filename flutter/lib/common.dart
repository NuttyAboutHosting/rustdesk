...
class MyTheme {
  ...
  // NAH: brand accent (orange) app-wide - buttons, highlights, selected states -
  // so the technician client is branded too (was RustDesk blue 0xFF0071FF).
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    useMaterial3: false,
    fontFamily: 'Nunito', // NAH brand typeface (bundled)
