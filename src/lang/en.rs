...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        // NAH: customer-facing support copy (Nutty About Hosting tone).
        ("nah_waiting_tip", "You're all set - hold tight. Keep this window open and one of our team will connect in a moment to help you out."),
        ("nah_request_access_tip", "wants to connect to help you. Choose what to allow below, then share your screen."),
        ("nah_accept_share", "Yes, share"),
        ("nah_not_yet", "Not yet"),
        ("nah_connected_tip", "Connected - you're in control and can stop anytime."),
        // NB: the support (incoming-only) client uses its own custom home
        // (_buildNahSupportHome), NOT "Your Desktop"/desk_tip - so those keep
        // their original wording here (only the technician client shows them).
        ...
        ("powered_by_me", "Nutty About Hosting - Because we care"),
