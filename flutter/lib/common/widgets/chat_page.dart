...
class ChatPage extends StatelessWidget implements PageShape {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider.value(
      value: chatModel,
      child: Container(
        // NAH: aubergine chat panel in the connection manager to match the
        // rest of the support UI (was the light scaffold colour).
        color: type == ChatPageType.desktopCM
                  ...
                  final chat = DashChat(
                    ...
                    inputOptions: InputOptions(
                      ...
                      inputDecoration: InputDecoration(
                        ...
                        hintStyle: type == ChatPageType.desktopCM
                            ? TextStyle(color: Colors.white.withOpacity(0.5))
                            : null,
                        filled: true,
                        fillColor: type == ChatPageType.desktopCM
                    ...
                    messageOptions: MessageOptions(
                      ...
                      messageDecorationBuilder:
                        ...
                        return defaultMessageDecoration(
                          // NAH: brand the chat bubbles (own = orange,
                          // other = a lighter aubergine) in the CM.
                          color: type == ChatPageType.desktopCM
                              ? (isOwnMessage
                                  ? const Color(0xFFFF6600)
                                  : const Color(0xFF5A3A68))
                              : (isOwnMessage
                                  ? MyTheme.accent
                                  : Colors.blueGrey),
                          borderTopLeft: 8,
