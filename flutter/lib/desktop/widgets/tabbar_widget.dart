            ...
            child: Column(
              children: [
                SizedBox(
                  ...
                  // NAH: aubergine title bar on the support (incoming-only)
                  // client so it matches the body instead of the dark default.
                  child: bind.isIncomingOnly()
                      ? ColoredBox(
                          color: const Color(0xFF3D2044), child: _buildBar())
                      : _buildBar(),
                ),
                  ...
                  children: [
                    ...
                    Offstage(
                      ...
                      child: Row(children: [
                        ...
                        Offstage(
                            // NAH: show the app name in the title bar of the
                            // incoming-only support home too (not just when the
                            // host opts in via showTitle), and use the real app
                            // name instead of the hard-coded "RustDesk". Bold +
                            // white to sit on the aubergine bar (see below).
                            offstage: !showTitle && !isIncomingHomePage,
                            child: Text(
                              bind.mainGetAppNameSync(),
                              style: TextStyle(
                                fontSize: 13,
                                fontWeight: isIncomingHomePage
                                    ? FontWeight.w700
                                    : FontWeight.normal,
                                color: isIncomingHomePage ? Colors.white : null,
                              ),
                            ).marginOnly(left: 2))
                      ]).marginOnly(
                        left: 5,
